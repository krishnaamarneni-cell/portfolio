...
Given a topic, generate three COMPLETELY DIFFERENT platform-native versions.
...
- Build tension: problem then why it matters then insight then resolution
...
Empty line
3-5 short paragraphs (1-2 sentences each). Use "I" and "you". Include one specific number or real example.
...
2-3 short paragraphs with the insight/lesson
...
- Each platform version must feel GENUINELY DIFFERENT — not the same text reformatted.
